...
@section('content')
    ...
    <button type="button" id="downloadSelectedBtn" class="btn-pnl btn-pnl-success" disabled>
        <i class="fas fa-download me-1"></i> Download Selected (<span id="selectedCount">0</span>)
    </button>
    
    <a href="{{ route('pnl.export') }}" class="btn-pnl btn-pnl-info">
                    ...
                    @if ($pnlRecords->hasPages())
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $pnlRecords->previousPageUrl() }}"
                                ...
                                @for ($page = $start; $page <= $end; $page++)
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="{{ $pnlRecords->url($page) }}">{{ $page }}</a>
                                        </li>
                                    @endif
                                @endfor
                                ...
                                @if ($end < $pnlRecords->lastPage())
                                    ...
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="{{ $pnlRecords->url($pnlRecords->lastPage()) }}">{{ $pnlRecords->lastPage() }}</a>
                                    </li>
                                @endif
                                ...
                                @if ($pnlRecords->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $pnlRecords->nextPageUrl() }}" rel="next">Next
                                            &raquo;</a>
                                    </li>
                                @else
                                    <li class="page-item disabled" aria-disabled="true">
...
$(document).ready(function() {
    ...
    // ========== EXISTING CODE (Row click, Update PnL, etc.) ==========
